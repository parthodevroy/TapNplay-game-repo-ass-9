...
//         e.target.reset();
//         navigate(`${location.state?location.state:"/games"}`); // ✅ login হলে user profile page এ যাবে
//       })
//       .catch((err) => {
...
//           </form>
//           {/* google login */}
//              <button onClick={handelgooglelogin} className="btn bg-white w-full text-black border-[#e5e5e5]">
